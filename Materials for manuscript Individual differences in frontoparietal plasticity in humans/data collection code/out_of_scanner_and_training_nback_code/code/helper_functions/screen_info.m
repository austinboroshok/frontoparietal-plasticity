...
switch screen_name
    ...
    case 'emilyOffice'
        ...
        scr.skipSync            = 1;        % whether to skip timing tests, generally unwise to skip unless there is a known issue with tehm
    ...
    case 'Mackeyfmri'
        scr.screenNumber        = 0; %if computer in fMRI uses an external screen, not sure how that works yet                              
        scr.widthCm             = 26;                         
        scr.heightCm            = 16.2;                     
        scr.skipSync            = 1;
        ...
        scr.response_mapping    = {'r','y'}; %arbitrary based on button press colors, can change
    case 'MackeyLaptop'
